...
def main():
  ...
  if user_age < 16:
    print(f"This isn't the voting age anywhere: ", user_age)
    return

  if user_age >= 16:
    print(f"You can vote in Peturksbouipo where the voting age is: {str(Peturksbouipo)}")  
  else:
    print(f"You cannot vote in Peturksbouipo, where the voting age is: {str(Peturksbouipo)}")  
